            ...
            >
              ...
              <div className="flex py-5 justify-start">
                ...
                <div className="w-full border-r-2 border-custom-teal  flex-col flex justify-center px-5">
                  <h1 className="font-bold text-right">Statsss</h1>
                ...
                {/* right */}
                <div className="w-full border-l-2 border-custom-teal flex flex-col justify-center px-5">
              ...
              <div className="flex flex-col justify-center items-center gap-3">
                ...
                >
                  {wishlist.isWishlist ? (
                    <FaHeart style={{ fontSize: "1.75rem" }} />
                  ) : (
